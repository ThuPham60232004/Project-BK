...
const HomePage = () => {
    const items = [
        ...
        { icon: <LiaHotelSolid style={{ width: '25px', height: '25px' }} />, text: "Danh sách phòng", path: "/ListRoom" },
        { icon: <LiaHotelSolid style={{ width: '25px', height: '25px' }} />, text: "Danh sách đơn đặt phòng", path: "/ListBooking" },
        ...
        { icon: <LuListTodo style={{ width: '25px', height: '25px' }} />, text: "Phân quyền", path: "/" },
