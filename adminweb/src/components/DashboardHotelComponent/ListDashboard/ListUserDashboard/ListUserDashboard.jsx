...
const ListUserDashboard = () => {
  ...
  useEffect(()=>{
    ...
    try{
        const res= await axios.get(`http://localhost:9000/api/users/hotelAdmin/${storedIdAdmin}`);
        setUser(res.data);
  ...
  return (
    <div className='ListUserDashboard'>
      <div className='ListUserCointainerDashboard'> 
        <h2>Danh sách khách sạn</h2>
        <div className='ListUserCointainerBtnDashboard' onClick={handleClickAdd}>
